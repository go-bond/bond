...
type _tableAnyScanner struct {
	...
	scanIndex        func(ctx context.Context, i *Index[any], s Selector[any], tr *[]any, optBatch ...Batch) error
	scanForEach      func(ctx context.Context, f func(keyBytes KeyBytes, l Lazy[any]) (bool, error), optBatch ...Batch) error
	scanIndexForEach func(ctx context.Context, idx *Index[any], s Selector[any], f func(keyBytes KeyBytes, t Lazy[any]) (bool, error), optBatch ...Batch) error
}
...
func (a *_tableAnyScanner) ScanIndex(ctx context.Context, i *Index[any], s Selector[any], tr *[]any, optBatch ...Batch) error {
...
func (a *_tableAnyScanner) ScanIndexForEach(ctx context.Context, idx *Index[any], s Selector[any], f func(keyBytes KeyBytes, t Lazy[any]) (bool, error), optBatch ...Batch) error {
...
func TableAnyScanner[T any](scanner TableScanner[T]) TableScanner[any] {
	return &_tableAnyScanner{
		...
		scanIndex: func(ctx context.Context, i *Index[any], s Selector[any], tr *[]any, optBatch ...Batch) error {
			...
			err := scanner.ScanIndex(ctx, iAny, s.(Selector[T]), &ttr, optBatch...)
			if err != nil {
				return err
			}
		...
		scanIndexForEach: func(ctx context.Context, i *Index[any], s Selector[any], f func(keyBytes KeyBytes, t Lazy[any]) (bool, error), optBatch ...Batch) error {
			iAny := NewIndex[T](IndexOptions[T]{
				IndexID:   i.IndexID,
				IndexName: i.IndexName,
				IndexKeyFunc: func(keyBuilder KeyBuilder, t T) []byte {
