...
- [x] Phase 2: Add the deterministic benchmark/oracle harness, correct compression policy, compare table filters independently, retain reproducible manifests, and freeze the winning non-schema baseline.
...
- [x] Phase 7: Run the final full/race/focused compatibility suites, benchmark reproducibility and regression audit, backup/restore/rollback exercises, open-path and documentation audit, and publish the final accepted/rejected decisions.
