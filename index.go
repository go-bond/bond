...
type IndexID uint8
type IndexKeyFunction[T any] func(builder KeyBuilderSpec, t T) []byte
...
func (o IndexOrder) OrderBigInt(b *big.Int, bits int, orderType IndexOrderType) IndexOrder {
	...
	o.keyBuilder.AddBigIntField(b, bits)
	return o
}
